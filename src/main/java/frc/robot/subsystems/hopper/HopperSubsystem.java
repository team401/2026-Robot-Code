...
public class HopperSubsystem {
    ...
    public static MotorIO getTalonFXMotorIO() {
        return MotorIOTalonFX.newLeader(MechanismConfig.builder()
        .build(), new TalonFXConfiguration());
    }

    public static MotorIO getTalonFXMotorPositionSimIO() {
        return MotorIOTalonFXPositionSim.newLeader(MechanismConfig.builder()
        .build(), new TalonFXConfiguration());
    }
