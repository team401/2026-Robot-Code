...
import coppercore.wpilib_interface.subsystems.dio_switch.DigitalInputIOCANdiSimNT;

public class HomingSwitchIOSimNT extends DigitalInputIOCANdiSimNT implements HomingSwitchIO {
  protected final CANdiSignal outputSignal;
  protected final CANdiConfiguration candiConfig;

  public HomingSwitchIOSimNT(
      CANDeviceID id,
    ...
    super(id, candiConfig, inputSignal, ntPath, defaultIsOpenValue);
