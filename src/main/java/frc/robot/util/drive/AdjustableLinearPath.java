...
public class AdjustableLinearPath {
    ...
    public AdjustableLinearPath(TrapezoidProfile.Constraints linearConstraints, TrapezoidProfile.Constraints angularConstraints) {
        this.linearProfile = new TrapezoidProfile(linearConstraints);
        this.angularProfile = new TrapezoidProfile(angularConstraints);
    }

    public void setConstraints(TrapezoidProfile.Constraints linearConstraints, TrapezoidProfile.Constraints angularConstraints) {
        this.linearProfile = new TrapezoidProfile(linearConstraints);
        this.angularProfile = new TrapezoidProfile(angularConstraints);
    }
