    ...
    public Command toCommand(AutoActionData data) {
        ...
        if (profile == null) {
            ...
            if (profile.getBeelineRadius() == null) {
                profile = profile.withBeelineRadius(JsonConstants.driveConstants.defaultAutoPilotBeelineRadius);
            }
            if (profile.getErrorTheta() == null) {
                profile = profile.withErrorTheta(JsonConstants.driveConstants.defaultAutoPilotHeadingTolerance);
            }
